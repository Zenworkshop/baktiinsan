      ...
      <div className="relative mx-auto px-6 py-4 bg-white shadow-md">
        <motion.div initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center relative">
            ...
            <Link to="/donasi" className="text-gray-900 hover:text-gray-300 transition">Donasi</Link>
            ...
            <div className="relative group">
              ...
              <div className="absolute hidden group-hover:block top-full left-0 bg-[#f9f9f9] shadow-lg rounded-lg py-2 w-48 z-50">
                ...
                <Link to="/chemical-anchor" className="block px-4 py-2 text-gray-900 hover:bg-gray-200">Penghasilan</Link>
                <Link to="/chemical-rebar" className="block px-4 py-2 text-gray-900 hover:bg-gray-200">Maal</Link>
                <Link to="/pull-out-test" className="block px-4 py-2 text-gray-900 hover:bg-gray-200">Emas</Link>
                <Link to="/coring-lantai" className="block px-4 py-2 text-gray-900 hover:bg-gray-200">Fitrah</Link>
                <Link to="/fire-stop" className="block px-4 py-2 text-gray-900 hover:bg-gray-200">Fidyah</Link>
              </div>
            </div>

            <Link to="/gallery" className="text-gray-900 hover:text-gray-300 transition">Sedekah</Link>
            <Link to="/gallery" className="text-gray-900 hover:text-gray-300 transition">Waqaf</Link>
            <Link to="/gallery" className="text-gray-900 hover:text-gray-300 transition">Qurban</Link>
        ...
        {isOpen && (
          <div className="absolute top-full left-0 w-full bg-white text-gray-900 z-40 p-6 space-y-4 shadow-md rounded-b-lg">
            ...
            <Link to="/donasi" className="text-base font-medium block" onClick={() => setIsOpen(false)}>Donasi</Link>

            <div>
              <p className="text-base font-medium mb-2">Zakat</p>
              <div className="ml-4 mt-2 flex flex-col space-y-2">
                <Link to="/chemical-anchor" className="text-sm" onClick={() => setIsOpen(false)}>Penghasilan</Link>
                <Link to="/chemical-rebar" className="text-sm" onClick={() => setIsOpen(false)}>Maal</Link>
                <Link to="/pull-out-test" className="text-sm" onClick={() => setIsOpen(false)}>Emas</Link>
                <Link to="/coring-lantai" className="text-sm" onClick={() => setIsOpen(false)}>Fitrah</Link>
                <Link to="/fire-stop" className="text-sm" onClick={() => setIsOpen(false)}>Fidyah</Link>
              </div>
            </div>

            <Link to="/gallery" className="text-base font-medium block" onClick={() => setIsOpen(false)}>sedekah</Link>
            <Link to="/gallery" className="text-base font-medium block" onClick={() => setIsOpen(false)}>Waqaf</Link>
            <Link to="/gallery" className="text-base font-medium block" onClick={() => setIsOpen(false)}>Qurban</Link>
          </div>
        )}
      </div>
    </nav>
